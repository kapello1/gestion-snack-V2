...
import { KeyRound, UtensilsCrossed, ArrowLeft, RefreshCw } from 'lucide-react';
          ...
          <div className="bg-white rounded-b-3xl shadow-[0_32px_80px_rgba(0,0,0,0.6)] px-6 sm:px-8 py-8 sm:py-10">
            ...
            <div className="flex flex-col items-center mb-7">
              ...
              <div className="flex items-center gap-2 w-full mt-4">
                ...
                <span className="text-[11px] font-bold text-emerald-300 px-2 tracking-widest">MOT DE PASSE</span>
